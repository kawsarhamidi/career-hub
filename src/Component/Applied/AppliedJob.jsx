...
const AppliedJob = ({ job }) => {
    const {id, company_logo, job_title, company_name, remote_or_onsite, location, fulltime_or_parttime, salary , phone, email, educational_requirements, job_responsibility,job_description} = job;
    console.log(job);
    return (
        <div>
